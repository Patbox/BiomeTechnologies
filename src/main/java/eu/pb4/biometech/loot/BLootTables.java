...
public class BLootTables {
    public static final LootPoolEntryType BIOME_ESSENCE = Registry.register(Registry.LOOT_POOL_ENTRY_TYPE, id("biome_essence"), new LootPoolEntryType(new BiomeEssenceEntry.Serializer()));
